...
class Puzzle {
  Puzzle(this.img, this.settings) {
    ...
    _pieces = List.generate(pieceCount, (index) {
      ...
      final piecePos = PiecePos(index, hIndex, vIndex);
      ...
      return Piece(img, piecePos, piecePos, region, isMovable, isBlankPiece);
    }, growable: false);
  }
...
/// ピースの位置
@freezed
class PiecePos with _$PiecePos {
  const factory PiecePos(
    /// 1次元インデックス
    int index,
